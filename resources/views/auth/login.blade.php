...
<body>
  ...
  <script src="{{asset('stisla/node_modules/popper.js/dist/popper.js') }}"></script>
  <script src="{{asset('stisla/node_modules/tooltip.js/dist/tooltip.js') }}"></script>
  <script src="{{asset('stisla/node_modules/bootstrap/js/bootstrap.min.js') }}"></script>
